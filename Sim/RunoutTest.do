...
add wave -noupdate /a_lathetoptestriscv/LatheTopSim/latheInt/latheCtlProc/RunOut_Ctl/limit
...
WaveRestoreCursors {{Cursor 1} {61085000 ps} 0}
...
update
WaveRestoreZoom {0 ps} {69610444 ps}
