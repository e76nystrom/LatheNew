...
set_input_delay -add_delay  -clock [get_clocks {sysClk}]  2.000 [get_ports {aux[0]}]
set_input_delay -add_delay  -clock [get_clocks {sysClk}]  2.000 [get_ports {aux[1]}]
set_input_delay -add_delay  -clock [get_clocks {sysClk}]  2.000 [get_ports {aux[2]}]
set_input_delay -add_delay  -clock [get_clocks {sysClk}]  2.000 [get_ports {aux[3]}]
set_input_delay -add_delay  -clock [get_clocks {sysClk}]  2.000 [get_ports {aux[4]}]
set_input_delay -add_delay  -clock [get_clocks {sysClk}]  2.000 [get_ports {aux[5]}]
set_input_delay -add_delay  -clock [get_clocks {sysClk}]  2.000 [get_ports {aux[6]}]
set_input_delay -add_delay  -clock [get_clocks {sysClk}]  2.000 [get_ports {aux[7]}]
