...
module  SystemClk_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //SystemClk_altclkctrl_0_sub
...
module  SystemClk_altclkctrl_0  (
    ...
    SystemClk_altclkctrl_0_sub  SystemClk_altclkctrl_0_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
